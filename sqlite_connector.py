...
class SqliteConnector(BaseConnector):
    ...
    def _handle_test_connectivity(self, param):
        ...
        self.save_progress(f"Using SQLite Version {version}")
    ...
    def _handle_run_query(self, param):
        ...
        try:
            ...
            return action_result.set_status(phantom.APP_ERROR, "Error running query", e)
    ...
    def _handle_list_columns(self, param):
        ...
        if not re.match(r"^[a-z0-9_$]+$", table_name, re.IGNORECASE):
            return action_result.set_status(phantom.APP_ERROR, "table_name can only contains alphanumeric characters + '_' and '$'")
    ...
    def initialize(self):
        ...
        if path is None:
            ...
            path = f"{state_dir}/{asset_id}_db.db"
        else:
